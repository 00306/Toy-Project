...
struct ImageSectorViewModel {
    var sectorA: DetailParagraph = DetailParagraph(headline: "Jerome Powell", 
                                           ...
                                           images: ["Jerome Powell", "Helicopter Money", "Stock account 2020", "upbit", "Korea Interest Rate", "Real estate in Seoul"], 
                                           imageDescriptions: ["연준의 총 자산 그래프", "증권계좌 개설 증가율", "국내 암호화폐 거래소 ‘업비트’ 신규 가입자 추이", "한국 금리 차트", "서울시 아파트 매매가격 지수"])
    
    var sectorAKeywords = ["코로나 양적완화 통화정책", "부모보다 가난한 세대 세대 갈등 MZ세대 기성세대"]
    
    var headline: String {
        return self.sectorA.headline
    }
    
    var titles: [String] {
        return self.sectorA.titles
    }
    
    var paragraphs: [String] {
        return self.sectorA.paragraphs
    }
    
    var images: [String] {
        return self.sectorA.images
    }
    
    var imageDescriptions: [String] {
        return self.sectorA.imageDescriptions
    }
}
