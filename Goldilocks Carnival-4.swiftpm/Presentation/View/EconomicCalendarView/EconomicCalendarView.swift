            ...
            do {
                    ...
                    for var index in 0..<arr2.count {
                        ...
                        if index >= arr2.startIndex && index < arr2.endIndex {
                            if arr2[index].contains("예측:") || arr2[index].contains("USD") || arr2[index].contains("KRW") || arr2[index].contains("EUR") || arr2[index].contains("GBP") || arr2[index].contains("JPY") || arr2[index].contains("CNY") || arr2[index].contains("실제:") {
                        ...
                        if let result = regex?.matches(in: arr2[index], options: [], range: NSRange(location: 0, length: arr2[index].count)) {
                            ...
                            if !rexStrings.isEmpty && arr2[index].contains("이전:") {
