        ...
        GeometryReader { proxy in
            VStack(spacing: 0) {
                ...
                HStack(alignment: .bottom, spacing: 5) {
                    BannerView(width: proxy.size.width, height: proxy.size.height)
                }
                    ...
                    GeometryReader { geometry in
                        VStack(spacing: 3) {
                            ...
                            HStack(alignment: .top) {
                                ...
                                GIFView(isGIFClicked: self.isGIFClicked, width: geometry.size.width, height: geometry.size.height)
                            }
                            .frame(width: geometry.size.width, height: geometry.size.height / 4)
